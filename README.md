...
Grizzly Parrot Trading is a futures trading education site with market structure articles, tools, book pages, SEO metadata, and custom HTML/CSS/JS.

Grizzly Greens is a lawn care and outdoor maintenance education site with article hubs, internal linking, sitemap generation, and responsive layouts.
...
I am also building Togivo, a React/Firebase prototype for live parent-child guided learning over video. The project includes synced lesson state, separate parent and child views, session links, room logic, and live video integration.
